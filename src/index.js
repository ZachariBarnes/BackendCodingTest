...
app.get('/Directory', (req, res) => { res.send('Valid endpoints are as follows: /Directory, /, /Pangrams, /Animate'); });
app.get('/', (req, res) => { res.send('Valid endpoints are as follows: /Directory, /, /Pangrams, /Animate'); });
